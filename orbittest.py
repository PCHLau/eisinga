...
def plotter():
    ...
    for i, el in enumerate(objects):
        ...
        plt.contour(X_coord, Y_coord, Z_coord, levels=[1], colors=(color), linewidths=0.5)
    ...
    plt.savefig('static/orbittest.png', dpi=1000, bbox_inches='tight', pad_inches=0, transparent=True)
